...
SECRET_KEY = 'django-insecure-)grf%_(lmf)ic6_^ff18_7e2al^m%y)zda84)m*()nh9q(gn!k'
...
AUTHENTICATION_BACKENDS = [
    'django.contrib.auth.backends.ModelBackend',            # your existing email/password login
