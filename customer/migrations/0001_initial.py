# Generated by Django 5.1.6 on 2025-05-29 08:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('New Order', 'New Order'), ('Item Shipped', 'Item Shipped'), ('Item Delivered', 'Item Delivered'), ('Item Cancelled', 'Item Cancelled'), ('Item Returned', 'Item Returned')], default='New Order', max_length=100)),
